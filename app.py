...
def read_master_from_sheets(league):
    ...
    try:
        ...
        for col in df.columns:
            # Fix: Sheets may use comma as decimal separator (European locale)
            # Try converting as-is first, then with comma→dot replacement
            ...
            # Only apply if at least half converted successfully
            orig_notna = df[col].replace("", pd.NA).notna().sum()
...
with tabs[1]:
    ...
    with c2:
        ...
        fig.update_layout(**PT, height=520,
